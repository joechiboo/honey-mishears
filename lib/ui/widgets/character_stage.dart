...
/// 角色舞台：背景 + 角色 + 情境特效。
///
/// [useRive] 由外層先檢查素材是否存在再決定；素材還沒好時走 PlaceholderCharacter，
/// 兩者吃同一組 CharacterPose，所以之後換素材不必改這裡以外的程式。
class CharacterStage extends StatelessWidget {
  const CharacterStage({
    super.key,
    required this.pose,
    required this.effect,
    required this.useRive,
    this.lotteryDraw,
  });
    ...
    return Stack(
      ...
      children: [
        ...
        Align(
          ...
          child: useRive
              ? SizedBox(width: 260, height: 300, child: RiveCharacter(pose: pose))
